...
export default function Loading(){
    return(
        <div className="text-white animate-pulse bg-black dark:bg-black dark:text-slate-600 w-12/12 min-h-screen overflow-x-hidden">
            <div className="flex mb-48 h-auto w-auto ">
                ...
                <div className="w-full absolute lg:w-2/3 h-screen lg:relative">
                    ...
                    <div className="hidden lg:w-1/2 bg-gray-700 lg:h-3/4 top-12 lg:block lg:absolute right-24">
                   </div>
                </div>
            </div>
        </div>
